...
class HealthcareService < Resource
  ...
  SEARCH_PARAMS = {
    ...
    specialty: 'specialty',
    program: 'program',
    veteran: 'program-requirement-va-status',
    new_patient: 'new-patient',
    insurance_status: 'social-service-insurance-status',
    birth_sex: 'social-service-birthsex',
    veteran_status: 'social-service-va-status',
    employment_status: 'social-service-employment-status',
