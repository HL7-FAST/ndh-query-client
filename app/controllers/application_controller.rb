...
class ApplicationController < ActionController::Base
  ...
  FHIR.logger.level = if Rails.env.production?
                        Logger::WARN
                      else
                        Logger::DEBUG
                      end
  ...
  def fetch_payers
    ...
    flash.now[:error] ||= "Retrieving payer organizations failed: #{e.message}"
  end
  ...
  def fetch_plans(id = nil)
    ...
    parameters[:_id] = id if id.present?
    ...
    if good_response(insurance_plans.response[:code])
      insurance_plans.resource.entry.map do |entry|
        next unless entry.resource.id.present? && entry.resource.name.present?
  ...
  NON_INDIVIDUAL_SPECIALTIES = [
    ...
    { value: 'http://nucc.org/provider-taxonomy|251C00000X',
      name: 'Developmentally Disabled Services Day Training Agency' },
    ...
    { value: 'http://nucc.org/provider-taxonomy|261QE0700X',
      name: 'End-Stage Renal Disease (ESRD) Treatment Clinic/Center' },
    ...
    { value: 'http://nucc.org/provider-taxonomy|261QM0801X',
      name: 'Mental Health Clinic/Center (Including Community Mental Health Center)' },
    { value: 'http://nucc.org/provider-taxonomy|261QM0850X', name: 'Adult Mental Health Clinic/Center' },
    { value: 'http://nucc.org/provider-taxonomy|261QM0855X',
      name: 'Adolescent and Children Mental Health Clinic/Center' },
    { value: 'http://nucc.org/provider-taxonomy|261QM1000X', name: 'Migrant Health Clinic/Center' },
    { value: 'http://nucc.org/provider-taxonomy|261QM1100X',
      name: 'Military/U.S. Coast Guard Outpatient Clinic/Center' },
    { value: 'http://nucc.org/provider-taxonomy|261QM1101X',
      name: 'Military and U.S. Coast Guard Ambulatory Procedure Clinic/Center' },
    { value: 'http://nucc.org/provider-taxonomy|261QM1102X',
      name: 'Military Outpatient Operational (Transportable) Component Clinic/Center' },
    { value: 'http://nucc.org/provider-taxonomy|261QM1103X',
      name: 'Military Ambulatory Procedure Visits Operational (Transportable) Clinic/Center' },
    ...
    { value: 'http://nucc.org/provider-taxonomy|261QR0401X',
    ...
    { value: 'http://nucc.org/provider-taxonomy|261QR0405X',
      name: 'Substance Use Disorder Rehabilitation Clinic/Center' },
    ...
    { value: 'http://nucc.org/provider-taxonomy|276400000X',
      name: 'Substance Use Disorder Rehabilitation Hospital Unit' },
    ...
    { value: 'http://nucc.org/provider-taxonomy|2865X1600X',
      name: 'Operational (Transportable) Military General Acute Care Hospital' },
    ...
    { value: 'http://nucc.org/provider-taxonomy|3104A0630X',
      name: 'Assisted Living Facility (Behavioral Disturbances)' },
    ...
    { value: 'http://nucc.org/provider-taxonomy|315P00000X',
      name: 'Intellectual Disabilities Intermediate Care Facility' },
    ...
    { value: 'http://nucc.org/provider-taxonomy|320600000X',
      name: 'Intellectual and/or Developmental Disabilities Residential Treatment Facility' },
    { value: 'http://nucc.org/provider-taxonomy|320700000X',
      name: 'Physical Disabilities Residential Treatment Facility' },
    { value: 'http://nucc.org/provider-taxonomy|320800000X',
      name: 'Mental Illness Community Based Residential Treatment Facility' },
    { value: 'http://nucc.org/provider-taxonomy|320900000X',
      name: 'Intellectual and/or Developmental Disabilities Community Based Residential Treatment Facility' },
    { value: 'http://nucc.org/provider-taxonomy|322D00000X',
      name: 'Emotionally Disturbed Childrens Residential Treatment Facility' },
    ...
    { value: 'http://nucc.org/provider-taxonomy|3245S0500X',
      name: 'Childrens Substance Abuse Rehabilitation Facility' },
    ...
    { value: 'http://nucc.org/provider-taxonomy|385HR2060X',
      name: 'Child Intellectual and/or Developmental Disabilities Respite Care' },
    ...
    { value: 'http://nucc.org/provider-taxonomy|332800000X',
    ...
    { value: 'http://nucc.org/provider-taxonomy|335V00000X',
    ...
    { value: 'http://nucc.org/provider-taxonomy|3418M1110X',
      name: 'Military or U.S. Coast Guard Ground Transport Ambulance' },
    { value: 'http://nucc.org/provider-taxonomy|3418M1120X',
      name: 'Military or U.S. Coast Guard Air Transport Ambulance' },
    { value: 'http://nucc.org/provider-taxonomy|3418M1130X',
      name: 'Military or U.S. Coast Guard Water Transport Ambulance' },
  ...
  INDIVIDUAL_AND_GROUP_SPECIALTIES = [
    ...
    { value: 'http://nucc.org/provider-taxonomy|103TM1800X',
      name: 'Intellectual & Developmental Disabilities Psychologist' },
    ...
    { value: 'http://nucc.org/provider-taxonomy|133VN1201X',
      name: 'Obesity and Weight Management Nutrition Registered Dietitian' },
    { value: 'http://nucc.org/provider-taxonomy|133VN1301X', name: 'Oncology Nutrition Registered Dietitian' },
    { value: 'http://nucc.org/provider-taxonomy|133VN1401X',
      name: 'Pediatric Critical Care Nutrition Registered Dietitian' },
    ...
    { value: 'http://nucc.org/provider-taxonomy|163WA0400X',
      name: 'Addiction (Substance Use Disorder) Registered Nurse' },
    ...
    { value: 'http://nucc.org/provider-taxonomy|163WC1600X',
      name: 'Continuing Education/Staff Development Registered Nurse' },
    ...
    { value: 'http://nucc.org/provider-taxonomy|163WP0807X',
      name: 'Child & Adolescent Psychiatric/Mental Health Registered Nurse' },
    ...
    { value: 'http://nucc.org/provider-taxonomy|163WR1000X',
      name: 'Reproductive Endocrinology/Infertility Registered Nurse' },
    ...
    { value: 'http://nucc.org/provider-taxonomy|1835P0018X',
    ...
    { value: 'http://nucc.org/provider-taxonomy|204C00000X',
      name: 'Sports Medicine (Neuromusculoskeletal Medicine) Physician' },
    ...
    { value: 'http://nucc.org/provider-taxonomy|207KI0005X',
      name: 'Clinical & Laboratory Immunology (Allergy & Immunology) Physician' },
    ...
    { value: 'http://nucc.org/provider-taxonomy|207LC0200X',
      name: 'Critical Care Medicine (Anesthesiology) Physician' },
    { value: 'http://nucc.org/provider-taxonomy|207LH0002X',
      name: 'Hospice and Palliative Medicine (Anesthesiology) Physician' },
    ...
    { value: 'http://nucc.org/provider-taxonomy|207NI0002X',
      name: 'Clinical & Laboratory Dermatological Immunology Physician' },
    ...
    { value: 'http://nucc.org/provider-taxonomy|207PE0004X',
      name: 'Emergency Medical Services (Emergency Medicine) Physician' },
    { value: 'http://nucc.org/provider-taxonomy|207PE0005X',
      name: 'Undersea and Hyperbaric Medicine (Emergency Medicine) Physician' },
    { value: 'http://nucc.org/provider-taxonomy|207PH0002X',
      name: 'Hospice and Palliative Medicine (Emergency Medicine) Physician' },
    { value: 'http://nucc.org/provider-taxonomy|207PP0204X',
    ...
    { value: 'http://nucc.org/provider-taxonomy|207PT0002X',
      name: 'Medical Toxicology (Emergency Medicine) Physician' },
    ...
    { value: 'http://nucc.org/provider-taxonomy|207QH0002X',
      name: 'Hospice and Palliative Medicine (Family Medicine) Physician' },
    ...
    { value: 'http://nucc.org/provider-taxonomy|207RA0000X',
      name: 'Adolescent Medicine (Internal Medicine) Physician' },
    { value: 'http://nucc.org/provider-taxonomy|207RA0001X',
      name: 'Advanced Heart Failure and Transplant Cardiology Physician' },
    { value: 'http://nucc.org/provider-taxonomy|207RA0002X', name: 'Adult Congenital Heart Disease Physician' },
    { value: 'http://nucc.org/provider-taxonomy|207RA0201X',
      name: 'Allergy & Immunology (Internal Medicine) Physician' },
    ...
    { value: 'http://nucc.org/provider-taxonomy|207RC0200X',
      name: 'Critical Care Medicine (Internal Medicine) Physician' },
    ...
    { value: 'http://nucc.org/provider-taxonomy|207RH0002X',
      name: 'Hospice and Palliative Medicine (Internal Medicine) Physician' },
    ...
    { value: 'http://nucc.org/provider-taxonomy|207RI0001X',
      name: 'Clinical & Laboratory Immunology (Internal Medicine) Physician' },
    ...
    { value: 'http://nucc.org/provider-taxonomy|207RM1200X',
      name: 'Magnetic Resonance Imaging (MRI) Internal Medicine Physician' },
    ...
    { value: 'http://nucc.org/provider-taxonomy|207SM0001X',
      name: 'Molecular Genetic Pathology (Medical Genetics) Physician' },
    ...
    { value: 'http://nucc.org/provider-taxonomy|207VB0002X',
      name: 'Obesity Medicine (Obstetrics & Gynecology) Physician' },
    { value: 'http://nucc.org/provider-taxonomy|207VC0200X',
      name: 'Critical Care Medicine (Obstetrics & Gynecology) Physician' },
    { value: 'http://nucc.org/provider-taxonomy|207VE0102X', name: 'Reproductive Endocrinology Physician' },
    { value: 'http://nucc.org/provider-taxonomy|207VF0040X',
      name: 'Female Pelvic Medicine and Reconstructive Surgery (Obstetrics & Gynecology) Physician' },
    { value: 'http://nucc.org/provider-taxonomy|207VG0400X', name: 'Gynecology Physician' },
    { value: 'http://nucc.org/provider-taxonomy|207VH0002X',
      name: 'Hospice and Palliative Medicine (Obstetrics & Gynecology) Physician' },
    ...
    { value: 'http://nucc.org/provider-taxonomy|207WX0108X',
      name: 'Uveitis and Ocular Inflammatory Disease (Ophthalmology) Physician' },
    { value: 'http://nucc.org/provider-taxonomy|207WX0109X', name: 'Neuro-ophthalmology Physician' },
    { value: 'http://nucc.org/provider-taxonomy|207WX0110X',
      name: 'Pediatric Ophthalmology and Strabismus Specialist Physician' },
    { value: 'http://nucc.org/provider-taxonomy|207WX0120X',
      name: 'Cornea and External Diseases Specialist Physician' },
    { value: 'http://nucc.org/provider-taxonomy|207WX0200X',
      name: 'Ophthalmic Plastic and Reconstructive Surgery Physician' },
    ...
    { value: 'http://nucc.org/provider-taxonomy|207XS0114X',
      name: 'Adult Reconstructive Orthopaedic Surgery Physician' },
    ...
    { value: 'http://nucc.org/provider-taxonomy|207YX0007X',
      name: 'Plastic Surgery within the Head & Neck (Otolaryngology) Physician' },
    ...
    { value: 'http://nucc.org/provider-taxonomy|207ZP0007X',
      name: 'Molecular Genetic Pathology (Pathology) Physician' },
    { value: 'http://nucc.org/provider-taxonomy|207ZP0101X', name: 'Anatomic Pathology Physician' },
    { value: 'http://nucc.org/provider-taxonomy|207ZP0102X',
      name: 'Anatomic Pathology & Clinical Pathology Physician' },
    ...
    { value: 'http://nucc.org/provider-taxonomy|2080H0002X',
      name: 'Pediatric Hospice and Palliative Medicine Physician' },
    { value: 'http://nucc.org/provider-taxonomy|2080I0007X',
      name: 'Pediatric Clinical & Laboratory Immunology Physician' },
    ...
    { value: 'http://nucc.org/provider-taxonomy|2080P0008X',
      name: 'Pediatric Neurodevelopmental Disabilities Physician' },
    ...
    { value: 'http://nucc.org/provider-taxonomy|2080P0204X',
      name: 'Pediatric Emergency Medicine (Pediatrics) Physician' },
    ...
    { value: 'http://nucc.org/provider-taxonomy|2081H0002X',
      name: 'Hospice and Palliative Medicine (Physical Medicine & Rehabilitation) Physician' },
    { value: 'http://nucc.org/provider-taxonomy|2081N0008X',
      name: 'Neuromuscular Medicine (Physical Medicine & Rehabilitation) Physician' },
    ...
    { value: 'http://nucc.org/provider-taxonomy|2081P0301X',
      name: 'Brain Injury Medicine (Physical Medicine & Rehabilitation) Physician' },
    { value: 'http://nucc.org/provider-taxonomy|2081P2900X',
      name: 'Pain Medicine (Physical Medicine & Rehabilitation) Physician' },
    { value: 'http://nucc.org/provider-taxonomy|2081S0010X',
      name: 'Sports Medicine (Physical Medicine & Rehabilitation) Physician' },
    { value: 'http://nucc.org/provider-taxonomy|208200000X', name: 'Plastic Surgery Physician' },
    { value: 'http://nucc.org/provider-taxonomy|2082S0099X',
      name: 'Plastic Surgery Within the Head and Neck (Plastic Surgery) Physician' },
    ...
    { value: 'http://nucc.org/provider-taxonomy|2083A0300X',
      name: 'Addiction Medicine (Preventive Medicine) Physician' },
    ...
    { value: 'http://nucc.org/provider-taxonomy|2083P0011X',
      name: 'Undersea and Hyperbaric Medicine (Preventive Medicine) Physician' },
    { value: 'http://nucc.org/provider-taxonomy|2083P0500X',
      name: 'Preventive Medicine/Occupational Environmental Medicine Physician' },
    { value: 'http://nucc.org/provider-taxonomy|2083P0901X',
      name: 'Public Health & General Preventive Medicine Physician' },
    { value: 'http://nucc.org/provider-taxonomy|2083S0010X', name: 'Sports Medicine (Preventive Medicine) Physician' },
    { value: 'http://nucc.org/provider-taxonomy|2083T0002X',
      name: 'Medical Toxicology (Preventive Medicine) Physician' },
    { value: 'http://nucc.org/provider-taxonomy|2083X0100X', name: 'Occupational Medicine Physician' },
    { value: 'http://nucc.org/provider-taxonomy|2084A0401X',
      name: 'Addiction Medicine (Psychiatry & Neurology) Physician' },
    { value: 'http://nucc.org/provider-taxonomy|2084A2900X', name: 'Neurocritical Care Physician' },
    { value: 'http://nucc.org/provider-taxonomy|2084B0002X',
      name: 'Obesity Medicine (Psychiatry & Neurology) Physician' },
    { value: 'http://nucc.org/provider-taxonomy|2084B0040X', name: 'Behavioral Neurology & Neuropsychiatry Physician' },
    { value: 'http://nucc.org/provider-taxonomy|2084D0003X',
      name: 'Diagnostic Neuroimaging (Psychiatry & Neurology) Physician' },
    { value: 'http://nucc.org/provider-taxonomy|2084F0202X', name: 'Forensic Psychiatry Physician' },
    { value: 'http://nucc.org/provider-taxonomy|2084H0002X',
      name: 'Hospice and Palliative Medicine (Psychiatry & Neurology) Physician' },
    { value: 'http://nucc.org/provider-taxonomy|2084N0008X',
      name: 'Neuromuscular Medicine (Psychiatry & Neurology) Physician' },
    { value: 'http://nucc.org/provider-taxonomy|2084N0400X', name: 'Neurology Physician' },
    { value: 'http://nucc.org/provider-taxonomy|2084N0402X',
      name: 'Neurology with Special Qualifications in Child Neurology Physician' },
    ...
    { value: 'http://nucc.org/provider-taxonomy|2084P0301X',
      name: 'Brain Injury Medicine (Psychiatry & Neurology) Physician' },
    ...
    { value: 'http://nucc.org/provider-taxonomy|2084S0010X',
      name: 'Sports Medicine (Psychiatry & Neurology) Physician' },
    { value: 'http://nucc.org/provider-taxonomy|2084S0012X',
      name: 'Sleep Medicine (Psychiatry & Neurology) Physician' },
    ...
    { value: 'http://nucc.org/provider-taxonomy|2085H0002X',
      name: 'Hospice and Palliative Medicine (Radiology) Physician' },
    ...
    { value: 'http://nucc.org/provider-taxonomy|2086H0002X',
      name: 'Hospice and Palliative Medicine (Surgery) Physician' },
    ...
    { value: 'http://nucc.org/provider-taxonomy|2088F0040X',
      name: 'Female Pelvic Medicine and Reconstructive Surgery (Urology) Physician' },
    ...
    { value: 'http://nucc.org/provider-taxonomy|208G00000X',
      name: 'Thoracic Surgery (Cardiothoracic Vascular Surgery) Physician' },
    ...
    { value: 'http://nucc.org/provider-taxonomy|224ZE0001X',
      name: 'Environmental Modification Occupational Therapy Assistant' },
    { value: 'http://nucc.org/provider-taxonomy|224ZF0002X',
      name: 'Feeding, Eating & Swallowing Occupational Therapy Assistant' },
    { value: 'http://nucc.org/provider-taxonomy|224ZL0004X', name: 'Low Vision Occupational Therapy Assistant' },
    { value: 'http://nucc.org/provider-taxonomy|224ZR0403X',
      name: 'Driving and Community Mobility Occupational Therapy Assistant' },
    ...
    { value: 'http://nucc.org/provider-taxonomy|225500000X',
      name: 'Respiratory/Developmental/Rehabilitative Specialist/Technologist' },
    ...
    { value: 'http://nucc.org/provider-taxonomy|225CA2400X',
      name: 'Assistive Technology Practitioner Rehabilitation Counselor' },
    { value: 'http://nucc.org/provider-taxonomy|225CA2500X',
      name: 'Assistive Technology Supplier Rehabilitation Counselor' },
    { value: 'http://nucc.org/provider-taxonomy|225CX0006X',
      name: 'Orientation and Mobility Training Rehabilitation Counselor' },
    { value: 'http://nucc.org/provider-taxonomy|225X00000X', name: 'Occupational Therapist' },
    { value: 'http://nucc.org/provider-taxonomy|225XE0001X',
      name: 'Environmental Modification Occupational Therapist' },
    { value: 'http://nucc.org/provider-taxonomy|225XE1200X', name: 'Ergonomics Occupational Therapist' },
    { value: 'http://nucc.org/provider-taxonomy|225XF0002X',
      name: 'Feeding, Eating & Swallowing Occupational Therapist' },
    ...
    { value: 'http://nucc.org/provider-taxonomy|225XR0403X',
      name: 'Driving and Community Mobility Occupational Therapist' },
    ...
    { value: 'http://nucc.org/provider-taxonomy|2278P1004X',
      name: 'Pulmonary Diagnostics Certified Respiratory Therapist' },
    { value: 'http://nucc.org/provider-taxonomy|2278P1005X',
      name: 'Pulmonary Rehabilitation Certified Respiratory Therapist' },
    { value: 'http://nucc.org/provider-taxonomy|2278P1006X',
      name: 'Pulmonary Function Technologist Certified Respiratory Therapist' },
    { value: 'http://nucc.org/provider-taxonomy|2278P3800X',
      name: 'Palliative/Hospice Certified Respiratory Therapist' },
    { value: 'http://nucc.org/provider-taxonomy|2278P3900X',
      name: 'Neonatal/Pediatric Certified Respiratory Therapist' },
    { value: 'http://nucc.org/provider-taxonomy|2278P4000X',
      name: 'Patient Transport Certified Respiratory Therapist' },
    { value: 'http://nucc.org/provider-taxonomy|2278S1500X',
      name: 'SNF/Subacute Care Certified Respiratory Therapist' },
    ...
    { value: 'http://nucc.org/provider-taxonomy|2279P1004X',
      name: 'Pulmonary Diagnostics Registered Respiratory Therapist' },
    { value: 'http://nucc.org/provider-taxonomy|2279P1005X',
      name: 'Pulmonary Rehabilitation Registered Respiratory Therapist' },
    { value: 'http://nucc.org/provider-taxonomy|2279P1006X',
      name: 'Pulmonary Function Technologist Registered Respiratory Therapist' },
    { value: 'http://nucc.org/provider-taxonomy|2279P3800X',
      name: 'Palliative/Hospice Registered Respiratory Therapist' },
    { value: 'http://nucc.org/provider-taxonomy|2279P3900X',
      name: 'Neonatal/Pediatric Registered Respiratory Therapist' },
    { value: 'http://nucc.org/provider-taxonomy|2279P4000X',
      name: 'Patient Transport Registered Respiratory Therapist' },
    { value: 'http://nucc.org/provider-taxonomy|2279S1500X',
      name: 'SNF/Subacute Care Registered Respiratory Therapist' },
    ...
    { value: 'http://nucc.org/provider-taxonomy|246QL0901X',
      name: 'Diplomate Laboratory Management Specialist/Technologist' },
    ...
    { value: 'http://nucc.org/provider-taxonomy|2471C1101X',
      name: 'Cardiovascular-Interventional Technology Radiologic Technologist' },
    { value: 'http://nucc.org/provider-taxonomy|2471C1106X',
      name: 'Cardiac-Interventional Technology Radiologic Technologist' },
    ...
    { value: 'http://nucc.org/provider-taxonomy|2471M1202X',
      name: 'Magnetic Resonance Imaging Radiologic Technologist' },
    { value: 'http://nucc.org/provider-taxonomy|2471M2300X', name: 'Mammography Radiologic Technologist' },
    { value: 'http://nucc.org/provider-taxonomy|2471N0900X',
      name: 'Nuclear Medicine Technology Radiologic Technologist' },
    ...
    { value: 'http://nucc.org/provider-taxonomy|2471V0106X',
      name: 'Vascular-Interventional Technology Radiologic Technologist' },
    ...
    { value: 'http://nucc.org/provider-taxonomy|364SC1501X',
      name: 'Community Health/Public Health Clinical Nurse Specialist' },
    ...
    { value: 'http://nucc.org/provider-taxonomy|364SP0807X',
      name: 'Child & Adolescent Psychiatric/Mental Health Clinical Nurse Specialist' },
    { value: 'http://nucc.org/provider-taxonomy|364SP0808X',
      name: 'Psychiatric/Mental Health Clinical Nurse Specialist' },
    { value: 'http://nucc.org/provider-taxonomy|364SP0809X',
      name: 'Adult Psychiatric/Mental Health Clinical Nurse Specialist' },
    { value: 'http://nucc.org/provider-taxonomy|364SP0810X',
      name: 'Child & Family Psychiatric/Mental Health Clinical Nurse Specialist' },
    { value: 'http://nucc.org/provider-taxonomy|364SP0811X',
      name: 'Chronically Ill Psychiatric/Mental Health Clinical Nurse Specialist' },
    { value: 'http://nucc.org/provider-taxonomy|364SP0812X',
      name: 'Community Psychiatric/Mental Health Clinical Nurse Specialist' },
    { value: 'http://nucc.org/provider-taxonomy|364SP0813X',
      name: 'Geropsychiatric Psychiatric/Mental Health Clinical Nurse Specialist' },
  ...
  PROGRAMS = [
    ...
    { value: 'http://terminology.hl7.org/CodeSystem/program|5',
      name: 'Adult Day Activity and Support Services (ADASS) Program' },
    ...
    { value: 'http://terminology.hl7.org/CodeSystem/program|9',
      name: 'Care Coordination & Supplementary Services (CCSS)' },
    ...
    { value: 'http://terminology.hl7.org/CodeSystem/program|33',
      name: 'National Disabilities Insurance Scheme (NDIS)' },
    ...
    { value: 'http://terminology.hl7.org/CodeSystem/program|41',
      name: 'Sexual Abuse Counselling and Prevention Program (SACPP)' },
  ...
  NUCC_CODES = [
    ...
    { value: 'http://nucc.org/provider-taxonomy|251T00000X',
      name: 'Program of All-Inclusive Care for the Elderly (PACE) Provider Organization' },
    ...
    { value: 'http://nucc.org/provider-taxonomy|385H00000X', name: 'Respite Care' },
    { value: 'http://nucc.org/provider-taxonomy|390200000X',
